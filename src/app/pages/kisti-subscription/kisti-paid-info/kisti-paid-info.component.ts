...
import { KistiService, KistiRecHistory,KistiRecGroup } from '../../../services/kisti.service';
import jsPDF from 'jspdf';
import autoTable from 'jspdf-autotable';

@Component({
  selector: 'app-kisti-paid-info',
  templateUrl: './kisti-paid-info.component.html',
  styleUrls: ['./kisti-paid-info.component.css']
})
export class KistiPaidInfoComponent implements OnInit {
  ...
  constructor(private kistiService: KistiService) {}
  ...
  loadKistiReceiveHistory(): void {
    ...
    this.kistiService.getkistireceiveamount().subscribe({
      next: (res) => {
