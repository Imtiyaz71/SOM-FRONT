...
import { accountservice,getreceive} from '../../../services/accountservice.service';
import { environment } from '../../../../environments/environment';

@Component({
  selector: 'app-subrecpt',
  templateUrl: './subrecpt.component.html',
  styleUrls: ['./subrecpt.component.css']
})
export class SubrecptComponent {
id!: number;
  paid: getreceive = {} as getreceive;
...
loadBorrowerData(id: number) {
  this.loading = true;
  this.accountservice.getsubscriptionreceiveById(id).subscribe({
    next: (res) => {
      if (res && res.length > 0) {
